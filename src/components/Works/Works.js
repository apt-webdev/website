        ...
        return (
            <section className="navbar-tab" id="my-works">
                ...
                <div className="div-content works-list plain-text">
                    ...
                    <Project name={'Responsive Website'}  image={'./pictures/responsive_0.png'} desc={'A web page with responsive design and some animations on components, with basic examples of flexbox and css grid system.'} label1={'javascript'}  label2={'html'} label3={'css'} date={'June 16, 2020'} ibe={'behance'}  igit={'github'} behref={'https://www.behance.net/gallery/111626221/portfolio-cards?tracking_source=project_owner_other_projects'} githref={'https://github.com/apt-webdev/basicwebsite'} />
                    ...
                    <Project name={'Thesis Project'} image={'./pictures/toolkit.png'} desc={'A Python toolkit that evaluates the usability of mobile applications. The goal is through click logs of users, evaluate its use over a specific period, to identify weak points that can be indicators of usability errors.'} label1={'python'}  label2={'tkinter'} label3={''}  date={'coming soon'} icon={''} igit={'github'} behref={''} githref={'https://github.com/apt-webdev/toolkit'}/>
